...
export function SiteHeader() {
  return <header className="site-header"><Link className="brand" href="/" aria-label="JHK Properties home"><span className="brand-mark">JHK</span><span>PROPERTIES</span></Link><nav aria-label="Main navigation"><Link href="/property-management">Property management</Link><Link href="/tenants">Tenants</Link></nav><a className="header-action" href="mailto:management@jhkproperties.com">Contact us <span>↗</span></a></header>;
}
